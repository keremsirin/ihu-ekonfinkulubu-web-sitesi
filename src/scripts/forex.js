!(function () {
  ...
  function r(t) {
    ...
    i.pathname
    return (
      "http:" === i.protocol && (e = e.replace(/:80$/, "")),
  ...
  ;(h.widgetId.get = function () {
    ...
    (c.prototype._replaceScript = function (t) {
      ...
      var s = this._scriptContentToJSON(),
        ...
        h = !!this.script.parentNode.querySelector(
      ...
      var l,
        d = isNaN(this.settings.height)
          ? this.settings.height
          : this.settings.height + "px",
        p = isNaN(this.settings.width)
          ? this.settings.width
      ...
      ;(this.settings.utm_source = location.hostname),
        ...
        (this.iframe = this._createIframe(m, p, n, r, a.id))
      var f = this.iframeContainer.querySelector(
      ...
      if (
        ...
        (function (t, e, i) {
          ...
          t.width &&
            ((i.iframe.style.width = t.width + "px"),
            (i.iframeContainer.style.width = t.width + "px")),
            (i.iframe.style.height = t.height + "px"),
            (i.iframeContainer.style.height =
              t.height + (i.hasCopyright ? 32 : 0) + "px")
        }),
        u)
      ) {
        var w = document.createElement("div")
        ;(w.style.height = "32px"),
          (w.style.lineHeight = "32px"),
          (w.style.width = p),
          (w.style.textAlign = "center"),
          (w.style.verticalAlign = "middle"),
          (w.innerHTML = c.innerHTML),
          this.iframeContainer.appendChild(w)
      }
    }),
      ...
      return 0 === t.length
        ...
        : "?" +
            (function (t) {
              ...
              (function (t, e) {
                for (
                  var i = Object.create(Object.getPrototypeOf(t)), r = 0, n = e;
                  r < n.length;
                  r++
                ) {
                  var o = n[r]
